...
public class HomeFragment extends Fragment{
    ...
    //
    String[] radiourlFirst = {"https://www.youtube.com/watch?v=LAaxBKp3080"};

    //
    String[] radionamesFirst = {"Radio Mirchi"};

    int[] radioimagesSecond = {R.drawable.bigfm,
                         R.drawable.vividhbharati,
                         R.drawable.airfmgold,
                         R.drawable.aakashvani,
                         R.drawable.airfmrainbow,
                         R.drawable.radiocity
    };


    //
    String[] radiourlSecond = {"https://radioindia.net/radio/sc-bb/icecast.audio",
                         "https://radioindia.net/radio/vividhbharti/icecast.audio",
                         "https://radioindia.net/radio/fm_gold/icecast.audio",
                         "https://radioindia.net/radio/esdcdn2_airakashvani/icecast.audio",
                         "https://radioindia.net/radio/rainbow_radio/icecast.audio",
                         "https://radioindia.net/radio/radio-city/icecast.audio"};

    //
    String[] radionamesSecond = {"92.7 BIG FM",
                           "Vividh Bharti",
                           "Air FM Gold",
                           "Air Live New 24x7",
                           "Air FM Rainbow",
